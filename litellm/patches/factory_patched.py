...
def function_call_prompt(messages: list, functions: list):
    function_prompt = """TOOL CALL MODE - Output ONE JSON object ONLY, no text, no explanation. REQUIRED FORMAT: {"name": "FUNCTION_NAME", "arguments": {"param": "value"}}. FUNCTION_NAME must be one of the listed function names. The following functions are available to you:"""
